...
function SlugPage({ params }: { params: { slug: string } }) {
	return (
		<div className='pt-[15vh] max-w-5xl mx-auto'>
			...
			<div className='flex mt-6 gap-6 item-center max-md:flex-col'>
				<Image
					src={'/author/sirojbek.jpg'}
					alt='author'
					width='155'
				...
				<div className='flex-1 flex flex-col space-y-4'>
					<h2 className='text-3xl font-creteRound'>Sirojbek Muxtorov</h2>
